...
import { validarAdmision, validarCancelarAdmision, validarConsistenciaDeAdmisiones } from '../middleware/validations.js'
import {
...
router.post('/cambiarEstado/:id&:estado', validarCancelarAdmision, cambiarEstado);
